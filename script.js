  ...
  while (true) {
    ...
    if (userChoiceLengthInput === null) {
      ...
      if (userChoiceLengthInput < 8 || userChoiceLengthInput > 128 || isNaN(userChoiceLengthInput) || userChoiceLengthInput == null) {
        ...
        return parseInt(userChoiceLengthInput);
      }
    }
  }
};
...
// generatePassword function based on user's criteria
function generatePassword() {
  ...
  // Convert password String array into a string
...
// Random function returns a random number for possibleCharacters array
// getRandom returns one character at a time
function getRandom(arr) {
  // Math.random only runs between 0 and 1
